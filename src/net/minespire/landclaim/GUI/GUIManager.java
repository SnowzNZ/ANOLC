...
public class GUIManager {
    ...
    public void openAllClaimsGUI(Player player, int numRegionsToSkip){
        ...
        for(String rg : allClaims) {
            ...
            if(Claim.playerIsOwnerOrMember(player, rgName, rgWorld).equalsIgnoreCase("Owner")) {
                if(!Claim.regionIsPlot(Bukkit.getWorld(rgWorld), rgName)) allClaimsGUI.addItem(Material.DIAMOND_BLOCK, colorize("&5" + rgName), parseLoreString("&fWorld: &9" + rgWorld), nextSlot);
                else allClaimsGUI.addItem(Material.DIAMOND_ORE, colorize("&5" + rgName), parseLoreString("&fWorld: &9" + rgWorld), nextSlot);
            }
            else if(Claim.playerIsOwnerOrMember(player, rgName, rgWorld).equalsIgnoreCase("Member")) {
                if(!Claim.regionIsPlot(Bukkit.getWorld(rgWorld), rgName)) allClaimsGUI.addItem(Material.IRON_BLOCK, colorize("&5" + rgName), parseLoreString("&fWorld: &9" + rgWorld), nextSlot);
                else allClaimsGUI.addItem(Material.IRON_ORE, colorize("&5" + rgName), parseLoreString("&fWorld: &9" + rgWorld), nextSlot);
            }
        }
    ...
    public void openClaimInspector(Player player, String regionName, String worldName) {
        ...
        if(player.hasPermission("landclaim.teleport") || player.hasPermission("landclaim.inspect.others"))inspectorGUI.addItem(Material.ENDER_PEARL, colorize("&3Teleport"), null);
        ...
        if((isOwner && player.hasPermission("landclaim.flageditor")) || player.hasPermission("landclaim.inspect.others")) inspectorGUI.addItem(Material.CYAN_BANNER, colorize("&3Flag Editor"), null);
        if((isOwner && player.hasPermission("landclaim.remove.own")) || player.hasPermission("landclaim.edit.others")) inspectorGUI.addItem(Material.STRUCTURE_VOID, colorize("&3Remove &5" + regionName), null);
    ...
    public void openOwnersMembersEditor(Player player, String regionName, String worldName){
        ...
        String ownerOrMember = Claim.playerIsOwnerOrMember(player, regionName, worldName);
        if((ownerOrMember != null && ownerOrMember.equalsIgnoreCase("Owner") && player.hasPermission("landclaim.addplayer")) || player.hasPermission("landclaim.edit.others")) inspectorGUI.addItem(Material.TOTEM_OF_UNDYING, colorize("&3Add Player to Claim"), null, firstSlot++);
    ...
    public void openTeleportGUI(Player player, String regionName, String worldName) {
        ...
        String ownerOrMember = Claim.playerIsOwnerOrMember(player, regionName, worldName);
        if((ownerOrMember != null && ownerOrMember.equalsIgnoreCase("Owner")) || player.hasPermission("landclaim.edit.others")) teleportGUI.addItem(Material.FURNACE, colorize("&3Remove Teleport Point"), parseLoreString("&fRemove the teleport|&fpoint for &5" + regionName + "&f."), 11);
        teleportGUI.addItem(Material.ENDER_PEARL, colorize("&3Teleport to &5" + regionName), null, 13);
        if((ownerOrMember != null && ownerOrMember.equalsIgnoreCase("Owner")) || player.hasPermission("landclaim.edit.others")) teleportGUI.addItem(Material.CRAFTING_TABLE, colorize("&3Set Teleport Point"), parseLoreString("&fSet the teleport|&fpoint for &5" + regionName + "&f to|&fyour current location."), 15);
    ...
    public void openTopYearRegions(Player player) {
        ...
        for(VoteRegion region : voteRegions){
            topYearRegions.addItem(Material.EMERALD, colorize("&6#" + countRegions++ + " &5Region of the Year"),
                    parseLoreString( "&5" + region.getRegionCommaWorld().split(",")[0] + "&7,&9" + region.getRegionCommaWorld().split(",")[1] + "|&3Votes (Past Year): &6" + region.getVotesThisYear() + "|&7Click to Visit"));
    ...
    public void openTopMonthRegions(Player player) {
        ...
        int countRegions = 1;
        for(VoteRegion region : voteRegions){
            topMonthRegions.addItem(Material.EMERALD, colorize("&6#" + countRegions++ + " &5Region of the Month"),
                    parseLoreString( "&5" + region.getRegionCommaWorld().split(",")[0] + "&7,&9" + region.getRegionCommaWorld().split(",")[1] + "|&3Votes (Past Month): &6" + region.getVotesThisMonth() + "|&7Click to Visit"));
            if(countRegions > 7) break;
        }
    ...
    public void openTopDayRegions(Player player) {
        ...
        int countRegions = 1;
        for(VoteRegion region : voteRegions){
            topDayRegions.addItem(Material.EMERALD, colorize("&6#" + countRegions++ + " &5Region of the Day"),
                    parseLoreString( "&5" + region.getRegionCommaWorld().split(",")[0] + "&7,&9" + region.getRegionCommaWorld().split(",")[1] + "|&3Votes (Past Day): &6" + region.getVotesToday() + "|&7Click to Visit"));
            if(countRegions > 7) break;
        }
